...
namespace GLS
{
    ...
    public partial class TeamNeeds
    {
        ...
        [NotNull]
        public Int32 WillReach { get; set; } //boolean 1 or 0
    }
    ...
    public partial class PosDropOff
    {
        ...
        public double SecondPlayerGrade { get; set; }
        public double ThirdPlayerGrade { get; set; }
        public double FourthPlayerGrade { get; set; }
        public double DropOff1 { get; set; }
        public double DropOff2 { get; set; }
        public double DropOff3 { get; set; }
    }
}